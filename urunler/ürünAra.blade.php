            ...
            <div class="row">
                        ...
                        <div class="shop-widget">
                            ...
                            <div class="shop-search mt-25">
                                <form class="shop-search-form" action="{{route('urunArama')}}" method="get">
                                    <input type="text" placeholder="Ürün Adı" name="u" value="{{$urunAdi}}">
                                    <button type="submit">
                ...
                @if(!empty($urunAdi))
                    @if(!$urunler->isNotEmpty())
                        <div class="col-lg-9">
                            <div id="kirmiziUyari"> ARADIĞINIZ ÜRÜN BULUNAMADI!</div>
                        </div>
                    @else
                        <div class="col-lg-9">
                            ...
                            <div class="grid-list-product-wrapper">
                                <div class="product-view product-grid">
                                    ...
                                    <div class="f-right mt-15">
                                        {{$urunler->appends(['u' => $urunAdi])->links("pagination::bootstrap-4")}}
                                    </div>
