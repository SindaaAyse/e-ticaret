                            ...
                            <div class="billing-select mb-20">
                                ...
                                <select name="ilce" id="ilce"  style="padding: 10px; height: 50px;">
                                    ...
                                    @foreach($ilceListesi as $ilceListesiD)
                                        <option value="{{$ilceListesiD->id}}">{{$ilceListesiD->ilce_adi}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@section('js')
    <script>
        ...
        $("#yeniAdresForm").submit(function (e) {
            e.preventDefault();
            var form = $(this);
