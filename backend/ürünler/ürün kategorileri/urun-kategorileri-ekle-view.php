            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="kategoriGuncelle" action="{{route('urunKategoriDuzenlePostKP')}}" method="post">
                                @csrf
                                <input type="hidden" name="katID" value="{{$kategoriBilgi->id}}">
                                <div class="row">
                                    <div class="col-lg-9 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="menuBaslik" class="control-label">KATEGORİ ADI</label>
                                            <input type="text" id="kategoriAdi" name="kategoriAdi" value="{{fonksiyon::buyukHarfeCevir($kategoriBilgi->adi)}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <label for="menuBaslik" class="control-label"> </label>
                                        <button class="btn btn-dark btn-block" style="margin-top: 7px;"> GÜNCELLE</button>
                                    </div>
                                </div>
...
@section('js')
    <script>
        ...
        $("#kategoriGuncelle").submit(function (e) {
            e.preventDefault();
            var form = $(this);
